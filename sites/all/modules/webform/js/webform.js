...
$(document).ready(function(){
	$('#edit-submitted-datos-acceso-contrasena').prop('type','password');
	$('#edit-submitted-datos-acceso-repetir-contrasena').prop('type','password');
	$('#edit-submitted-contrasenam').prop('type','password');
	
	
	
	$(document).on('click','.fullfill',function(){
		var opciones=$('.parentSelect').html();		
		$(this).html(opciones);		
		$(this).removeClass('fullfill');
		$(this).removeAttr('id');
